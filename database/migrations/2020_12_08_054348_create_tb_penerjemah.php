...
class CreateTbPenerjemah extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tb_penerjemah', function (Blueprint $table) {
            $table->increments('id_penerjemah');
            $table->string('NPWP', 255)->nullable();
            $table->string('nm_penerjemah', 255);
    ...
    {
        Schema::dropIfExists('tb_penerjemah');
    }
}
