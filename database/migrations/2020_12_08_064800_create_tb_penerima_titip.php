...
class CreateTbPenerimaTitip extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tb_penerima_titip', function (Blueprint $table) {
            $table->increments('id_penerima_titip');
    ...
    {
        Schema::dropIfExists('tb_penerima_titip');
    }
}
