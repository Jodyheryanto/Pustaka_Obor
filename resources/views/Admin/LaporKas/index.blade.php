...
@section('title', 'Laporan Kas Obor')
@section('bukubesar', true)
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Laporan Kas Buku Saat Ini</h4>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    @for($i = 0; $i < $max; $i++)
                                        <tr class="data-row">
                                            ...
                                            <th class="w-25">{{ number_format($piutangDebit[$i]['nominal'], 0, '', '.') }} ({{ $piutangDebit[$i]['note'] }})</th>
                                            @php
                                            ...
                                            <th class="w-25">{{ number_format($piutangKredit[$i]['nominal'], 0, '', '.') }} ({{ $piutangKredit[$i]['note'] }})</th>
                                            @php
