            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="steps-validation wizard-circle" action="{{ route('admin.inventori.induk-buku.create') }}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <!-- Step 1 -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="harga_jual" class="form-control required" data-validation-required-message="Harga Jual wajib diisi" data-validation-containsnumber-regex="([^0-9]*[0-9]+)+" placeholder="Harga Jual Buku">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" name="berat_buku" class="form-control required" data-validation-required-message="Berat Buku wajib diisi" data-validation-containsnumber-regex="([^0-9]*[0-9]+)+" placeholder="Berat Buku (1 buku)">
                                                    <div class="input-group-prepend">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="imgInp" class="form-control required"  data-validation-required-message="Gambar wajib diisi" name="photo" placeholder="Masukkan gambar (png/jpg/jpeg max 2MB)" onchange="return ValidateFileUpload()">
                                                <img id="img-pre" src="/images/example-image.jpg" style="width: auto; height: 200px;" alt="your image" />
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" name="persen_royalti_pengarang" id="persen_royalti_pengarang" min="0" max="100" value="10" class="form-control required" data-validation-containsnumber-regex="([^0-9]*[0-9]+)+" placeholder="Persentase royalti pengarang" data-validation-required-message="Persentase royalti wajib diisi">
                                                    <div class="input-group-prepend">
