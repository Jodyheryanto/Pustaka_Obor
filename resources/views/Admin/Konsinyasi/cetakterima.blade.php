...
<head>
    ...
    <title>Faktur Konsinyasi @if($fakturone->status_terjual == 1) (Bayar) @elseif(str_contains($fakturone->id_faktur_konsinyasi, 'FKTKNSR') == 1) (Retur) @endif</title>
</head>
    ...
    <div
        ...
        <div style="display: flex; flex-wrap: wrap; margin-right: -15px; margin-left: -15px;">
            ...
            <div
                ...
                <h2 style="font-weight: bolder; text-transform: uppercase;">Faktur Konsinyasi @if($fakturone->status_terjual == 1) (Bayar) @elseif(str_contains($fakturone->id_faktur_konsinyasi, 'FKTKNSR') == 1) (Retur) @endif</h2>
        ...
        <div style="display: flex; flex-wrap: wrap; margin-right: -15px; margin-left: -15px;  font-size: .7rem;">
            ...
            <div
                ...
                <p>Kepada</p>
                <p style="font-weight: bolder; margin-top: -10px;">Yth {{ $fakturone->supplier->nm_supplier }}</p>
                <p>
                    {{ $fakturone->supplier->alamat }} <br>
                    {{ $fakturone->supplier->kelurahan->name }} {{ $fakturone->supplier->kecamatan->name }} <br>
                    {{ $fakturone->supplier->kota->name }} <br>
                    {{ $fakturone->supplier->telepon }}
                </p>
            </div>
            <!-- END: Column 1 -->
