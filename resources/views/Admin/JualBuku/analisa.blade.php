...
<head>
    ...
    <title>LAPORAN ANALISA PENJUALAN BUKU</title>
</head>
            ...
            <table
                ...
                <thead style="display: table-header-group;">
                    <tr style="vertical-align: bottom; border-bottom: 1px solid #bbbbbb; text-transform: capitalize;">
                        ...
                        @else
                        <th scope="col" style="background-color: #fff; text-align: start;">ID Salesman</th>
                        <th scope="col" style="background-color: #fff; text-align: start;">Nama Salesman</th>
                        @endif
                        @if($kode == 0)
                        <th scope="col" style="background-color: #fff; text-align: start;">Qty Terjual</th>
                        @elseif($kode == 2 || $kode == 3)
                        <th scope="col" style="background-color: #fff; text-align: start;">Qty Terjual</th>
                        <th scope="col" style="background-color: #fff; text-align: start;">Nilai Jual</th>
                        @else
                        <th scope="col" style="background-color: #fff; text-align: start;">Nilai Jual</th>
                        @endif
                    </tr>
                  ...
                  @foreach($arrBuku as $data)
                    ...
                    @elseif($kode == 1)
                        <tr>
                            ...
                            <td
                                style="padding: 0.75rem;vertical-align: top; border-top: 1px solid #bbbbbb; background-color: #fff;">
                                Rp. {{ number_format($data['nilaijual'], 0, '', '.') }}
                            </td>
                        </tr>
                    @elseif($kode == 2)
                        <tr>
